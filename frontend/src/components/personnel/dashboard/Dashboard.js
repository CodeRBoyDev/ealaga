...
function Dashboard() {
  ...
  const fetchAttendees = () => {
    axios({
      ...
      setTotalUser(response.data.totalClient);
  ...
  const [getUserFilter, setUserFilter] = useState({ field: "barangay" });
  ...
  : getalluser.reduce((totals, alluser) => {
    if (alluser?.address?.barangay) {
      if (!totals[alluser.address.barangay]) {
        totals[alluser.address.barangay] = {
          name: alluser.address.barangay,
          total: 0
        };
      }
      totals[alluser.address.barangay].total++;
    }
    return totals;
  }, {})
    ...
    <div style={contentStyle}>
      ...
      <div class="container-fluid" style={{ marginBottom: "-50px" }}>
       <div class="row g-3 mb-3">
          <div class="col" id="thumb">
            <div class="thumbBox">
              ...
              <h1 style={{ marginTop: "-30px", fontWeight: "bold" }}>
                ...
                <img class="card-img img-fluid" style={{height: 80, width: 80, float: "right" }} src="https://res.cloudinary.com/du7wzlg44/image/upload/v1678032016/dwadwadwa_eihxj1.gif" alt=""/>
              </h1>
          ...
          <div class="col" id="thumb">
            <div class="thumbBox">
              <p style={{ fontWeight: "bold" }}>Total Elderly User</p>
              <h1 style={{ marginTop: "-30px", fontWeight: "bold" }}><CountUp end={getTotalUser == 0 ? 0 : getTotalUser} duration={0.5} delay={0.5} />
                ...
                <img class="card-img img-fluid" style={{height: 80, width: 80, float: "right" }} src="https://res.cloudinary.com/du7wzlg44/image/upload/v1678032337/elderlys2_p1j8sm.gif" alt=""/>
          ...
          <div class="col" id="thumb">
            <div class="thumbBox">
              ...
              <h1 style={{ marginTop: "-30px", fontWeight: "bold" }}><CountUp end={getTotalApplicant == 0 ? 0 : getTotalApplicant} duration={0.5} delay={0.5} />
                ...
                <img class="card-img img-fluid" style={{height: 80, width: 80, float: "right" }} src="https://res.cloudinary.com/du7wzlg44/image/upload/v1678034713/giphy_4_ovnpop.gif" alt=""/>
          ...
          <div class="col" id="thumb">
            <div class="thumbBox">
              ...
              <h1 style={{ marginTop: "-30px", fontWeight: "bold" }}><CountUp end={getAllDonation.length == 0 ? 0 : getAllDonation.length} duration={0.5} delay={0.5} />
                ...
                <img class="card-img img-fluid" style={{height: 80, width: 80, float: "right" }} src="https://res.cloudinary.com/du7wzlg44/image/upload/v1678032569/giphy_3_ln0dk4.gif" alt=""/>
              </h1>
              <a href="javascript:void(0)" onClick={() => navigate('/personnel/attendees')}>More</a>
            </div>
          </div>
          <div class="col" id="thumb">
            <div class="thumbBox">
              ...
              <h1 style={{ marginTop: "-30px", fontWeight: "bold" }}>
                ...
                <img class="card-img img-fluid" style={{height: 80, width: 80, float: "right" }} src="https://res.cloudinary.com/du7wzlg44/image/upload/v1678034714/giphy_5_rp6lar.gif" alt=""/>
              </h1>
              <a href="javascript:void(0)" onClick={() => navigate('/personnel/attendees')}>More</a>
            </div>
          </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 chart-container" id="thumb" >
            <Card >
              <h5><i style={{ float: "right" }} class="fas fa-users"></i>Elderly User</h5>
                    ...
                    getAllComment?.map(comment => {
                      ...
                      return <Carousel.Item>
                        ...
                        <Carousel.Caption>
                          ...
                          <h6 style={{ color: "#EF3A47" }}>Anonymously</h6>
                        </Carousel.Caption>
                      </Carousel.Item>
