...
// console.log(NavBarSides.NavBarSide);
  ...
  return (
    ...
    <ChakraProvider resetCSS={false}> 
            ...
            <ServicesH1>
            &nbsp;&nbsp;<LinkR to='/client/dashboard'><i className="fas fa-arrow-left"></i></LinkR>&nbsp;&nbsp;Profile Settings
        </ServicesH1>
              <div className="card overflow-hidden">
                <div className="row no-gutters row-bordered row-border-light">
                 ...
                 <App src={profilePreview}  alt="" />
                  ...
                  {getUserssss.account_verified === "not verified" ? 
                   ...
                   <LinkR className="list-group-item list-group-item-action" style={{opacity: 0.3, pointerEvents: "none"}} data-toggle="list" to="" onClick={()  => {fetchUser(); setVerifyMedicalInformation(false); setNavBarSide({NavBarSide: "Health Information"})}}><i className="fas fa-notes-medical"></i>&nbsp;&nbsp;Health Information</LinkR>
                ...
                (NavBarSides.NavBarSide === "Personal Information" ? <div className="list-group list-group-flush account-settings-links">
                <LinkR className="list-group-item list-group-item-action active" data-toggle="list" to=""  onClick={()  => {fetchUser(); setVerifyMedicalInformation(false); setNavBarSide({NavBarSide: "Personal Information"})}}><i className="far fa-user"></i>&nbsp;&nbsp;Personal Information</LinkR>
                <LinkR className="list-group-item list-group-item-action" data-toggle="list" to="" onClick={()  => {fetchUser(); setVerifyMedicalInformation(false); setNavBarSide({NavBarSide: "Health Information"})}}><i className="fas fa-notes-medical"></i>&nbsp;&nbsp;Health Information</LinkR>
                <LinkR className="list-group-item list-group-item-action" data-toggle="list" to="" onClick={()  => {fetchUser(); setVerifyMedicalInformation(false); setNavBarSide({NavBarSide: "Credentials"})}}><i className="fas fa-hockey-puck"></i>&nbsp;&nbsp;Credentials</LinkR>
              </div>
               : 
               NavBarSides.NavBarSide === "Health Information" ? <div className="list-group list-group-flush account-settings-links">
               <LinkR className="list-group-item list-group-item-action" data-toggle="list" to="" onClick={()  => {fetchUser(); setVerifyMedicalInformation(false); setNavBarSide({NavBarSide: "Personal Information"})}}><i className="far fa-user"></i>&nbsp;&nbsp;Personal Information</LinkR>
               <LinkR className="list-group-item list-group-item-action active" data-toggle="list" to="" onClick={()  => {fetchUser(); setVerifyMedicalInformation(false); setNavBarSide({NavBarSide: "Health Information"})}}><i className="fas fa-notes-medical"></i>&nbsp;&nbsp;Health Information</LinkR>
               <LinkR className="list-group-item list-group-item-action" data-toggle="list" to="" onClick={()  => {fetchUser(); setVerifyMedicalInformation(false); setNavBarSide({NavBarSide: "Credentials"})}}><i className="fas fa-hockey-puck"></i>&nbsp;&nbsp;Credentials</LinkR>
             </div>
                  ...
                  <div className="col-md-9">
                    ...
                    <Row>
                          ...
                          <Row>
                            ...
                            <TextField type="file" inputProps={{accept:"image/*"}} onChange={onChangeeditProfile} name="valid_id" color="secondary" fullWidth id="fullName" /> 
                            {!editIdPreview ? "": 
                              <div className="image-frameProfile2">
                    ...
                    :  <ProfileLoading />
                        ...
                        <TextWrapper>
                          <AppTitle>
                            <h2>Please check if you have the following requirements.</h2>
                          </AppTitle>
                        </TextWrapper>  
                      ...
                      {/* <Col  className="d-flex justify-content-center">
                        ...
                        AllHealthUser?.map(health => {
                          return <li style={{fontSize:"1.1rem", fontWeight: "bold",marginTop:"10px", marginLeft:"30px"}}>{health.health_problem}</li>
                        })
                        }
                        </ol>  
                        ...
                        <TextWrapper>
                          <AppTitle>
                            <h2>Please check if you have the following health conditions.</h2>
                          </AppTitle>
                        </TextWrapper>  
                        {AllHealth?.map(health => (
                           ...
                           key={health._id}
                           inline1
                           label={<span style={{ maxWidth: "150px", wordBreak: "break-all" }}>{health.health_problem}</span>}
                           name={health._id}
                           type="checkbox"
                           style={{fontSize:"1.1rem"}}
                           value={health._id}
