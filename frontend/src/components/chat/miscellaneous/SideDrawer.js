    ...
    <React.Fragment>
      ...
      >
        <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button variant="white" bg ='#EF3A47' onClick={onOpen} color="white"
        ...
        <Text fontSize="3xl" fontWeight='bold' color="#EF3A47" >
          CHAT
        </Text>
        ...
        <div>
          <Menu>
            <MenuButton p={1}>
              <NotificationBadge
                ...
                effect={Effect.SCALE}
              />
              <BellIcon fontSize="2xl" m={1} color="#EF3A47"/>
            </MenuButton>
            <MenuList pl={2}>
          ...
          {/* <Menu>
            <MenuButton as={Button} bg="blue.700"  rightIcon={<ChevronDownIcon/>}  
              ...
              <Avatar size="sm" cursor="pointer" name={user?.first_name} borderColor="black" borderWidth="2px" bg="yellow.400" color="black"/>
            </MenuButton>
